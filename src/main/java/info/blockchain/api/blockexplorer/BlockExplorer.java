...
public class BlockExplorer {
     ...
     * @throws APIException If the server returns an error
     */
    public Future<Address> getAddressAsync (String address) throws APIException, IOException {
       return getAddressAsync(address, null, null, null);
    }
     ...
     * @throws APIException If the server returns an error
     */
    public Future<List<UnspentOutput>> getUnspentOutputsAsync (String address) throws APIException, IOException {
        return getUnspentOutputsAsync(Arrays.asList(address), null, null);
    }
     ...
     */
    public Future<List<SimpleBlock>> getBlocksAsync () throws APIException, IOException {
        return getBlocksAsync(null);
    }
